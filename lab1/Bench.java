...
public class Bench {
    ...
    public static void main(final String[] args) {
        executionTimeReport("Quick.java: quicksort (default)", new Quick(false, false, 0)::sort);
        executionTimeReport("Quick.java: quicksort (shuffled)", new Quick(true, false, 0)::sort);
        executionTimeReport("Quick.java: quicksort (median of three)", new Quick(false, true, 0)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:10)", new Quick(false, false, 10)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:20)", new Quick(false, false, 20)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:30)", new Quick(false, false, 30)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:40)", new Quick(false, false, 40)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:50)", new Quick(false, false, 50)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:60)", new Quick(false, false, 60)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:70)", new Quick(false, false, 70)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:80)", new Quick(false, false, 80)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:90)", new Quick(false, false, 90)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:100)", new Quick(false, false, 100)::sort);
        executionTimeReport("Quick.java: quicksort (insertion cutoff:110)", new Quick(false, false, 110)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:120)", new Quick(false, false, 120)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:130)", new Quick(false, false, 130)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:140)", new Quick(false, false, 140)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:150)", new Quick(false, false, 150)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:160)", new Quick(false, false, 160)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:170)", new Quick(false, false, 170)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:180)", new Quick(false, false, 180)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:190)", new Quick(false, false, 190)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:200)", new Quick(false, false, 200)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:300)", new Quick(false, false, 300)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:400)", new Quick(false, false, 400)::sort);
        //executionTimeReport("Quick.java: quicksort (insertion cutoff:500)", new Quick(false, false, 500)::sort);
        executionTimeReport("Quick.java: quicksort (insertion cutoff:30000)", new Quick(false, false, 30000)::sort);
